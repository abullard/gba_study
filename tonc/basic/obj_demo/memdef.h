...
#define DCNT_BUILD(mode, layer, win, obj1d, objhbl) \
	(                                               \
		(((win) & 7) << 13) | (((layer) & 31) << 8) | (((obj1d) & 1) << 6) | (((oamhbl) & 1) << 5) | ((mode) & 7))
...
#define ATTR0_AFF 0x0100	 //!< Affine object 00000000 10000000
#define ATTR0_HIDE 0x0200	 //!< Inactive object 00000001 00000000
