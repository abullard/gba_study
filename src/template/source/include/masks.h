...
// AJB: almost all of this was stolen from tonc. obviously I learned how to use them,
// but I didn't need to reinvent the wheel
...
#define DCNT_OBJ_1D 0x0040 // enable 1D objects
...
#define DCTL_BG_PRIORITY_FIRST 0x0000  // render bg above all others
#define DCTL_BG_PRIORITY_SECOND 0x0001 // render bg second
#define DCTL_BG_PRIORITY_THIRD 0x0002  // render bg third
#define DCTL_BG_PRIORITY_FOURTH 0x0003 // render bg below all others
